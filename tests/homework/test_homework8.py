...
class Test_Assign8(unittest.TestCase):
    ...
    def test_add_widget1_inventory_of_10(self):
        add_inventory('Widget1', 10, self.widgets) #use self.widgets in your other test cases to as shown here
    ...
    def test_add_widget1_inventory_of_25(self):
        add_inventory('Widget1', 25, self.widgets)
    ...
    def test_add_widget2_inventory_of_15(self):
        add_inventory('Widget2', 15, self.widgets)
    ...
    def test_add_widget2_inventory_reduce_5(self):
        add_inventory('Widget2', -5, self.widgets)
